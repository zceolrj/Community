        ...
        pre: function(scope, element, attrs, _arg) {
          ...
          return angular.extend(range, {
            ...
            update: function(runningTotal, total) {
              ...
              var __width = rangeWidth * slider.elementWidth() / 100 > 0 ? "calc(" + rangeWidth + "% - " + this.widthAdjustment + ")" : '0';
              var _margin = Math.min(this.widthAdjustment, __width);
              return element.css({
                width: __width,
                'margin-left': _margin
              });
      ...
      element.on("touchstart", function(event) {
        ...
        mousemove = function(event) {
          return scope.$apply(function() {
            ...
            dp = (touch.screenX - startX) / slider.elementWidth() * slider.pTotal();
        ...
        mouseup = function() {
          ...
          return $document.unbind("touchend", mouseup);
        };
        ...
        return $document.on("touchend", mouseup);
      })
